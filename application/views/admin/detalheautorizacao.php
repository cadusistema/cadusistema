...
echo '<pre>';
print_r($autorizacaoDetalhe->occupation);
echo '</pre>';
?>
    <div class="container">
        <div class="content">
            ...
            <div class="field form-group">
                <? echo form_label("Tipo de Atividade:", 'tipodeatividades');
                echo $autorizacaoDetalhe->occupation; ?>
                <? echo form_input(array(
                    "id"       => "activitiesofinformationid",
                    "name"     => "activitiesofinformationid",
                    "class"    => "form-control input-sm",
