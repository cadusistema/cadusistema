<a href="javascript:void(0)" class="btn btn-primary" onclick="teste('link1')">Link 1</a>
<a href="javascript:void(0)" class="btn btn-success" onclick="teste('link2')">Link 2</a>
    ...
    function teste(arq) {
        switch (arq) {
            case 'link1':
                ...
                $('#carousel-example-generic1').fadeOut();
                break;

            case 'link2':
                $('#carousel-example-generic1').fadeIn();
                $('#carousel-example-generic').fadeOut();
                break;
